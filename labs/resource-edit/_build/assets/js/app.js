...
/***/ function(module, exports, __webpack_require__) {
	...
	var ResourceEditForm = __webpack_require__(59);

	var MetaBox = function MetaBox() {
	  store.subscribe(function () {
	    return document.title = 'Editing ' + store.getState().meta.pagetitle;
	  });
	  ...
	  store.dispatch(actions.updateResourceGroups({
	    'Group 3': true
	  }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactInvalidSetStateWarningDevTool = __webpack_require__(36);
	var warning = __webpack_require__(26);
	    ...
	    React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement('option', { selected: true, value: '0' }),
	          React.createElement(
	            'option',
	            { value: '1' },
	            'Blog (1)'
